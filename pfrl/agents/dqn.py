    ...
    def _batch_observe_train(
        ...
        for i in range(len(batch_obs)):
            ...
            if self.batch_last_obs[i] is not None:
                ...
                batch_recurrent_done = self.recurrent and len(self.replay_buffer.current_episode[i]) == self.episodic_update_len
                if batch_reset[i] or batch_done[i] or batch_recurrent_done:
